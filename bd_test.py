...
prof.save()
dep = Deposit(user_id=123, dispute=d1, method=1, payment_url="1234", coin_amount=0.00001)
dep.save()
dep = Deposit(user_id=345, dispute=d1, method=1, payment_url="1234", coin_amount=0.00001)
dep.save()